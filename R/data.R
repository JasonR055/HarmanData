...
#' data(IMR90)
#' library(Harman)
#' imr90.harman <- harman(imr90.data,
#'  expt=imr90.info$Treatment,
#'  batch=imr90.info$Batch)
#' imr90.data.corrected <- reconstructData(imr90.harman)
#"IMR90"
NULL
...
#' data(NPM)
#' library(Harman)
#' npm.harman <- harman(npm.data,
#'  expt=npm.info$Treatment,
#'    batch=npm.info$Batch)
#' npm.data.corrected <- reconstructData(npm.harman)
#"NPM"
NULL
